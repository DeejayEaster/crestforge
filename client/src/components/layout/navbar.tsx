  ...
  return (
    ...
    >
      <nav className="container-custom">
        <div className="flex justify-between items-center h-20">
          <div className="flex-shrink-0">
            <button
              ...
              className="font-display text-3xl font-bold text-primary tracking-tight hover:text-outline-1 transition-colors duration-200 flex flex-col justify-center items-center"
            >
              <span className="border-b">CRESTFORGE</span>
        ...
        {/* Mobile Navigation */}
        <div
          className={`md:hidden bg-white/95 backdrop-blur-sm border-t border-slate-200 transition-all duration-300 ${
            isOpen
