  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        >
          <source
            src="https://videos.pexels.com/video-files/19912008/19912008-uhd_2560_1440_24fps.mp4"
            type="video/mp4"
          />
        </video>
        ...
        <div className="text-center max-w-5xl mx-auto">
          <AnimatedSection variant="fadeInUp" delay={0.4}>
            <h1 className="font-display text-5xl sm:text-6xl lg:text-8xl font-bold text-white mb-8 leading-tight">
              Capital That <span className="gold-accent italic">Builds</span>
            </h1>
          </AnimatedSection>
          ...
          <AnimatedSection variant="fadeInUp" delay={0.6}>
            <p className="text-xl sm:text-2xl text-white/80 mb-12 max-w-4xl mx-auto leading-relaxed font-light">
              Specialized commercial financing for construction, bridge loans,
              SBA products, and commercial real estate. <u>We make it simple</u>
              .
              <br />
            </p>
          </AnimatedSection>
